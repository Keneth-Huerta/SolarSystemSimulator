...
public class SimulationController {
    ...
    private void initializeSimulation() {
        ...
        // Añadir satélites (lunas)
        
        // Luna de la Tierra
        // La Luna está a unos 384,400 km de la Tierra
        // Para una visualización adecuada, usamos un factor de escala mayor
        double moonScaleFactor = 12.0; // Aumentado para mejor visibilidad
        Moon luna = new Moon(
            "Luna", 
            7.342e22, 
            1737.1, 
            384400 * SCALE_FACTOR * moonScaleFactor, 
            27.32, 
            new Color(220, 220, 220), 
            2.0,
            tierra
        );
        solarSystem.addCelestialBody(luna);
        ...
        Moon io = new Moon(
            ...
            8.9e22, 
            1821, 
            421800 * SCALE_FACTOR * moonScaleFactor, 
            1.77, 
            new Color(255, 200, 0), 
            1.5,
            jupiter
        ...
        Moon europa = new Moon(
            ...
            4.8e22, 
            1560, 
            671100 * SCALE_FACTOR * moonScaleFactor, 
            3.55, 
        ...
        Moon ganimedes = new Moon(
            "Ganímedes", 
            1.48e23, 
            2634, 
            1070400 * SCALE_FACTOR * moonScaleFactor, 
            7.16, 
        ...
        Moon calisto = new Moon(
            "Calisto", 
            1.08e23, 
            2410, 
            1882700 * SCALE_FACTOR * moonScaleFactor, 
            16.69, 
        ...
        solarSystem.addCelestialBody(ganimedes);
        solarSystem.addCelestialBody(calisto);
        
        // Principal luna de Saturno - Titán
        Moon titan = new Moon(
            "Titán", 
            1.35e23, 
            2575, 
            1221870 * SCALE_FACTOR * moonScaleFactor, 
            15.95, 
